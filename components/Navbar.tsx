...
function Navbar() {
  return (
    <nav className="sticky top-0 z-10 bg-white border-gray-200 border-b shadow-sm dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <h1 className="text-3xl bg-gray-700 text-gray-100 ml-2 px-2 rounded-md">
          E-SHOP
        </h1>
